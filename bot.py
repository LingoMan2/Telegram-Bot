...
async def StartMessage(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    Main_Channel = "Your Channel Link"
    Chat_Link = "Your Channel Link"
    Third_Channel = "Your Channel Link"
    Youtube_Link = "Your Channel Link"
    ...
    if update.message.chat.type == "private":
        ...
        # Check If User Is Creator Or Not
            ...
            await context.bot.send_message(
                chat_id = update.message.chat_id,
                reply_to_message_id = update.message.id,
                text="Say To Your User First Join To Channels",
